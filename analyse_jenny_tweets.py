...
subscription_key = "XXX"  # azure subscription key
endpoint = "XXX"  # azure endpoint
...
def get_tweets():
    ...
    j_hashtags = {'hearingadvocacy', 'USBLN16', 'WorldBrailleDay',
                  ...
                  'AbilitySummit', 'microsofttranslator', 'NOWHITEFLAGS',
                  'NFB15',
                  'Disabilityconfident',
                  ...
                  'dyslexia', 'marmitethrone', 'BeFearless',
                  ...
                  'signlanguage', 'usbln15', 'MSEnvisionForum', 'Office365',
                  'asl',
                  ...
                  'AutismDay2016', 'UniteForParkinsons', 'inclusion',
                  'BREAKING',
                  ...
                  'britsabroad', 'LondonStrong', 'ChooseToInclude',
                  'Accessiblity',
                  'assistivetech', 'designforall', 'Autism',
                  'beforeandafter', 'WorldsMostEthicalCompanies',
                  'hurricaneharvey',
                  'guidedogsawards', 'CRPD', 'AbilityHacks', 'Chester',
                  'vacation',
                  'lovemyteam', 'CitiesUnlocked', 'ability2016', 'ZeroCon19',
                  'ada25',
                  'Accessible', 'IDPD2019', 'neverwashingmycheek',
                  'g4ebootcamp',
                  ...
                  'ndcautism16', 'SCNYC17',
                  'WorldAutismAwarenessDay', 'accessible',
                  'disabilityisastrength',
                  'hackathon', 'DeafProblems', 'GAAD',
                  'disability', 'cfasummit', 'MSIgnite', 'socialgood',
                  'EyeMine',
                  ...
                  'ImagineCup', 'tech',
                  'AccessibilityTips', 'wheelchair', 'MinecraftEDU',
                  'Gamescom2019',
                  ...
                  'SBLIII', 'worldbrailleday', 'lead', 'Invention',
                  'PSBJCorpCit',
                  'WAAD2015', 'autism',
                  'MicrosoftEvent',
                  'WindowsTip', 'AbilityAward', 'ALSicebucketchallenge',
                  'WinHEC',
                  ...
                  'AbilityWeek',
                  'NewTenPoundNote',
                  'MSFTSummit', 'CSUNATC19', 'DisAbility',
                  'DigitalTransformation',
                  'NFBWATD', 'likeadyslexic',
                  'DeepLearning', 'nowhiteflags', 'TEDxGlasgow2015', 'trust',
                  'OfficeforCats', 'linus', 'CBeebies', 'Tech4GoodAwards',
                  'CSUN18',
                  ...
                  'WorldStandardsDay', 'IDPD', 'MsIgnite', 'lovemyjob',
                  'MIEExpert',
                  'AltText', 'accessibility', 'rword', 'Word', 'Sundance',
                  'SOTU',
                  'ADA25', 'InternationalLiteracyDay', 'AmericanSignLanguage',
                  'ally',
                  'AGT',
                  'TheFeed', 'NDEAM', 'MicrosoftStream', 'MicrosoftTeams',
                  'PSA',
                  ...
                  'edtech',
                  'Redmond', 'InclusiveEducation', 'Nominations',
                  'abilitysummit',
                  'InternationalDisabilityDay', 'MVPSummit', 'CommunityStory',
                  'ImmersiveReader',
                  'grateful', 'UpgradeYourWorld',
                  'GlobalAccessibilityAwarenessDay',
                  'SmartCities', 'InclusionInAction', 'CSUN16',
                  'windowsinsider',
                  'InclusivetheFilm', 'learningtools', 'PurpleTuesday',
                  'IDPD2015',
