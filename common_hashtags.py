...
jenny = {'hearingadvocacy', 'USBLN16', 'WorldBrailleDay',
         ...
         'DeepLearning', 'TEDxGlasgow2015', 'linus', 'CBeebies',
         'Tech4GoodAwards', 'CSUN18',
         'GoHawks', 'ForbesUnder30', 'WSD2017', 'SXSW2019', 'fail',
         'DeafAwarenessMonth', 'WoV15', 'msignite2017', 'Apple',
         'WorldStandardsDay', 'IDPD',
         'AltText', 'accessibility', 'rword', 'Word', 'SOTU',
         ...
         'DisabilityAnswerDesk', 'hardofhearing',
         'AACAwarenessMonth', 'StrikeOutALS',
         'AutismAwarenessMonth', 'aoda', 'WIRED25', 'teamgleason',
         'Ability2016', 'SkypeTranslator', 'SXSW',
         'edtech', 'InclusiveEducation', 'Nominations', 'abilitysummit',
         'InternationalDisabilityDay', 'MVPSummit', 'CommunityStory',
         'ImmersiveReader',
         'GlobalAccessibilityAwarenessDay',
         'SmartCities', 'InclusionInAction', 'CSUN16',
         'InclusivetheFilm', 'learningtools', 'IDPD2015',
         'EUAccessCity', 'Inclusivethefilm', 'hearingloss',
         'disabilityinclusion',
         }
...
set5 = jenny.union(victor.union(molly))
fin = ', '.join(set4)
